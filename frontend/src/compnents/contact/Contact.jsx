...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setStatus({ loading: false, success: false, error: 'Error submitting form. Please try again.' });
    }
  };
      ...
      <div className="max-w-6xl mx-auto py-12 px-4">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">support@moodvibe.com</p>
                  </div>
                </div>
        ...
        <div className="mt-12 bg-white rounded-xl shadow-sm overflow-hidden">
          <iframe
            ...
            marginHeight="0"
            marginWidth="0"
            src="https://maps.google.com/maps?q=123%20Wellness%20Street%2C%20San%20Francisco%2C%20CA%2094107&t=&z=13&ie=UTF8&iwloc=&output=embed"
            className="border-0"
          ></iframe>
        </div>
      </div>
